...
//    public String getAudioFrequencyFormat() {
//        return AUDIO_FREQUENCY_FORMAT;
//    }
//
//    @Value("${UploadPictureUntil.audioFrequencyFormat}")
//    public void setAudioFrequencyFormat(String audioFrequencyFormat) {
//        AUDIO_FREQUENCY_FORMAT = audioFrequencyFormat;
//    }
...
//    }
//
//    @Value("${UploadPictureUntil.fileFormat}")
